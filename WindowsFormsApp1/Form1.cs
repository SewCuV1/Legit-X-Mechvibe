...
namespace MechKeyDroid
{
    public partial class Form1 : Form
    {
        ...
        private void volumeTrackBar_Scroll_1(object sender, ScrollEventArgs e)
        {
            
            
            
            
            volumeTrackBar.Value = e.NewValue;
            volumeLabel.Text = e.NewValue.ToString();
        }

        private void volumeTrackBar_Scroll(object sender, ScrollEventArgs e)
        {
            volumeTrackBar.Value = e.NewValue;
            volumeLabel.Text = e.ToString();

        }
        //coded by sewcu
        private void guna2Button1_Click(object sender, EventArgs e)
        {
            if (initButton.BorderColor == Color.Cyan)
            {

            }
            if (initButton.BorderColor == Color.FromArgb(35, 35, 35))
            {
                backgroundWorker.RunWorkerAsync();
        
                initButton.BorderColor = Color.Cyan;
            }
        }
